...
public class Transaction extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlEmpLayout.setVerticalGroup(
            ...
            .addGroup(pnlEmpLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(table, javax.swing.GroupLayout.DEFAULT_SIZE, 414, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
        try {
            ...
            rs=st.executeQuery("select transactions.id,transactions.account_no,transactions.type,transactions.amount,transactions.date_time FROM accounts,transactions where accounts.account_no=transactions.account_no AND accounts.value=0");
    ...
    private void btnLogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogoutActionPerformed
        setVisible(false);
        new Authentication().setVisible(true);        // TODO add your handling code here:
